...
<acme:form>
	...
	<acme:input-textbox code="administrator.money-exchange.form.label.default-currency" path="defaultCurrency" readonly="true"/>
	<acme:input-textbox code="administrator.money-exchange.form.label.accepted-currencies" path="acceptedCurrencies" readonly="true"/>
