...
<acme:list>
	<acme:list-column code="patron.patronage.list.label.code" path="code" width="25%"/>
	...
	<acme:list-column code="patron.patronage.list.label.status" path="status" width="25%"/>	
</acme:list>