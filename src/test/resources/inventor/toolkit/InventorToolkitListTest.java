...
public class InventorToolkitListTest extends TestHarness{
	...
	public void positive(final int recordIndex, final String code, final String title, 
						final String link, final String totalPrice, final String description,
						final String inventor, final String assemblyNotes) {
		...
		super.checkInputBoxHasValue("name", title);
